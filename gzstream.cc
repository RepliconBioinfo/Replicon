...
// Standard C++ Library".
// ============================================================================
// Other than putting gzstream into the GULI namespace, this is the original source
// for gzstream. Thank you to Deepak Bandyopadhyay, Lutz Kettner.
...
namespace GULI {
	...
	gzstreambuf* gzstreambuf::open(const char* name, int open_mode) {
		...
		if ((mode & std::ios::ate) || (mode & std::ios::app) || ((mode
				& std::ios::in) && (mode & std::ios::out))) return (gzstreambuf*) 0;
		char fmode[10];
		char* fmodeptr = fmode;
	...
	void gzstreambase::close() {
		if (buf.is_open()) if (!buf.close()) clear(rdstate() | std::ios::badbit);
	}
